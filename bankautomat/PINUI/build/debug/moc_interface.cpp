...
QT_MOC_LITERAL(1, 10, 5), // "testi"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 7), // "receive"
QT_MOC_LITERAL(4, 25, 1) // "s"

    },
    "Interface\0testi\0\0receive\0s"
};
...
void Interface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->testi((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Interface::testi)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Interface::testi(QString _t1)
{
