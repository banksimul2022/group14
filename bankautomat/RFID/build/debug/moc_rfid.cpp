...
QT_MOC_LITERAL(1, 5, 9), // "sendtoexe"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 6) // "recvID"

    },
    "RFID\0sendtoexe\0\0recvID"
};
...
void RFID::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->recvID(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RFID::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RFID::sendtoexe)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RFID::sendtoexe(QByteArray _t1)
{
